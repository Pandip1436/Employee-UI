...
export interface FeedbackData { _id: string; fromUser?: { name: string; profilePhotoUrl?: string | null }; toUser: string; type: string; rating?: number; strengths?: string; improvements?: string; comments?: string; anonymous: boolean; createdAt: string; }
