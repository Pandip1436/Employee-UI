...
import { Clock, FileCheck, AlertCircle, ArrowRight, Plus, CalendarDays, LayoutDashboard, ClipboardList, History } from "lucide-react";
        ...
        <>
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={() => setActiveTab("history")} className="flex items-center gap-1 text-xs font-medium text-indigo-600 dark:text-indigo-400 hover:underline">View All <ArrowRight className="h-3.5 w-3.5" /></button>
            </div>
