        ...
        const tiles = [
          {
            ...
            sub: `${entries.length} ${entries.length === 1 ? "instance" : "instances"} flagged`,
            icon: AlertTriangle,
            gradient: "from-rose-500 to-pink-600",
            ringColor: "shadow-rose-500/30",
            toneChip: "bg-rose-50 text-rose-700 ring-rose-500/20 dark:bg-rose-500/10 dark:text-rose-400 dark:ring-rose-400/25",
            toneLabel: "Review",
          },
          {
            label: "Employees",
            value: String(uniqueEmployees),
            sub: `${uniqueEmployees} ${uniqueEmployees === 1 ? "person" : "people"} affected`,
            icon: Users,
          ...
          },
          {
            ...
            sub: uniqueEmployees > 0 ? `${fmtHours(totalOvertime / uniqueEmployees)} avg per person` : "—",
            icon: Clock,
          ...
          {
            label: "Max OT (week)",
            value: fmtHours(maxOvertime),
            sub: maxOvertime > 8 ? "High exposure" : "Within range",
            icon: TrendingUp,
            gradient: "from-orange-500 to-rose-600",
            ringColor: "shadow-orange-500/30",
            toneChip: maxOvertime > 8
            ...
            toneLabel: maxOvertime > 8 ? "Burnout risk" : "Manageable",
          },
        ];
        return (
