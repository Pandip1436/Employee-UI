              ...
              >
                ...
                <div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-4">
                  <div className="rounded-lg bg-gray-50 dark:bg-gray-800 px-3 py-2">
                    ...
                    <div className="mt-1">
                      <span
                        className={`inline-flex items-center gap-1.5 rounded-full px-2 py-0.5 text-xs font-medium ${tConfig.badge}`}
                      >
                  ...
                  <div className="rounded-lg bg-gray-50 dark:bg-gray-800 px-3 py-2">
                    ...
                    <p className="mt-0.5 text-sm font-bold text-gray-900 dark:text-white">
                      {fmtDate(leave.startDate)} &mdash; {fmtDate(leave.endDate)}
                    </p>
                  </div>
                  <div className="rounded-lg bg-gray-50 dark:bg-gray-800 px-3 py-2">
                    <p className="text-[10px] font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-500">
