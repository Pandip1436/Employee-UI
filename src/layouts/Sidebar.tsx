...
const links: SidebarLink[] = [
  ...
  { to: "/leaves", label: "Leave Dashboard", icon: CalendarDays, roles: ["employee", "manager"], section: "Leave" },
  { to: "/leave/apply", label: "Apply Leave", icon: ClipboardList, roles: ["employee", "manager"], section: "Leave" },
  { to: "/leave/approvals", label: "Leave Approvals", icon: CheckSquare, roles: ["admin", "manager"], section: "Leave" },
  { to: "/attendance/wfh", label: "WFH Requests", icon: Laptop, roles: [], excludeRoles: ["admin"], section: "Leave" },
  { to: "/wfh/approvals", label: "WFH Approvals", icon: Laptop, roles: ["admin", "manager"], section: "Leave" },
  { to: "/attendance/compoff", label: "Comp-Off", icon: Gift, roles: [], excludeRoles: ["admin"], section: "Leave" },
  ...
  { to: "/learning/certifications", label: "Certifications", icon: GraduationCap, roles: [], excludeRoles: ["admin"], section: "Learning" },
